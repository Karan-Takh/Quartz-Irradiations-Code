...
# Add standard quartz sample data to the new sheet
# Create empty list for standard
standard = []

with open('Standard Sample Data - Sheet1.csv', mode='r') as csv_file:
    csv_reader = csv.reader(csv_file)
    for a in csv_reader:
        standard.append(str(a[1]))


df = pd.read_csv(x, index_col='wavelength')
df.insert(0, "Standard", standard)
